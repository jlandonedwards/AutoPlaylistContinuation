...
if __name__ == '__main__':
    ...
    args.add_argument('--data_dir', type=str, default='./data_preprocessed/data', help="directory where preprocessed data is stored")
    args.add_argument('--val_dir', type=str, default='./val', help="directory where to witre validation sets to")
    args.add_argument('--train_dir', type=str, default='./train', help="directory where to write training sets to")
    args.add_argument('--dict_dir', type=str, default='./data_preprocessed/id_dicts', help="directory where to write training sets to")
    ...
    # Concatination of the ordered validation sets 1-9
